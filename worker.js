...
const BOT_TOKEN = "1065187993:AAE9ovhBlz3o6UBdfJDRD2OV_gjtRnsTkyk"; // Insert your bot token.
const BOT_WEBHOOK = "/endpoint"; // Let it be as it is.
const BOT_SECRET = "firo"; // Insert a powerful secret text (only [A-Z, a-z, 0-9, _, -] are allowed).
const BOT_OWNER = 356520246; // Insert your telegram account id.
const BOT_CHANNEL = -1002328106290; // Insert your telegram channel id which the bot is admin in.
const SIA_SECRET = "hersi"; // Insert a powerful secret text and keep it safe.
